...
namespace BLL.Interface.Entities
{
    ...
    public class PlatinumAccount : Account
    {
        ...
        private const float COEFFICIENT_BENEFIT = 1.3f;

        #endregion

        #region Fields

        private readonly AccountType accountType = AccountType.Platinum;
        ...
        internal PlatinumAccount(PersonalInfo info, IAccountNumberCreateService creator)
            : base(info, creator) { }
        ...
        /// <returns></returns>
        public bool Equals(PlatinumAccount other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((PlatinumAccount)obj);
        }
