...
namespace BLL.Interface.Entities
{
    ...
    /// Account type Base
    /// </summary>
    public class BaseAccount : Account, IEquatable<BaseAccount>
    {
        #region Consts

        private const float COEFFICIENT_BENEFIT = 1.0f;

        #endregion

        #region Fields

        private readonly AccountType accountType = AccountType.Base;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((BaseAccount)obj);
        }
